...
function showResults() {
    const totalQuestions = questions[selectedTopic][selectedLevel].length;
    const percentage = Math.round((score / totalQuestions) * 100);
    document.getElementById('resultSummary').innerText = `You answered ${score} out of ${totalQuestions} questions correctly.`;
    document.getElementById('percentage').innerText = `Your score: ${percentage}%`;
...
function goBack() {
    ...
    currentQuestion = 0;
    score = 0;
    // Go back to the Topics and Levels page
    showPage('topics');
}
